...
import { createCopperTexture, createDeckTexture } from '../textures';
...
export const M = {
  ...
  sail: new THREE.MeshStandardMaterial({ color: 0xe2d9b4, roughness: 1, metalness: 0, side: THREE.DoubleSide, transparent: true, opacity: 0.87 }),
  ...
  water: new THREE.MeshStandardMaterial({ color: 0x0a3050, roughness: 0.04, metalness: 0.12, transparent: true, opacity: 0.86 }),
} as const;
